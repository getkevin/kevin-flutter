...
@visibleForTesting
const methodChannel = MethodChannel('kevin_flutter_core_android');

class KevinFlutterCoreAndroid extends KevinFlutterCorePlatformInterface {
  static void registerWith() {
    KevinFlutterCorePlatformInterface.instance = KevinFlutterCoreAndroid();
  }
  ...
  Future<bool> setTheme({
    ...
    arguments.addAll({KevinFlutterCoreArguments.theme: androidTheme.themeName});
