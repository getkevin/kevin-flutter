...
mixin _$Creditor {
  ...
  List<CreditorAccount> get accounts => throw _privateConstructorUsedError;
...
class _$_Creditor extends _Creditor {
  ...
  @override
  String toString() {
    return 'Creditor(id: $id, name: $name, accounts: $accounts, logo: $logo, informationUnstructured: $informationUnstructured, country: $country, website: $website, phone: $phone, email: $email, address: $address)';
  }
...
abstract class _Creditor extends Creditor {
  ...
  String get name;
  @override
  List<CreditorAccount> get accounts;
  @override
  String get logo;
  @override
