...
#
Pod::Spec.new do |s|
  s.name             = 'kevin_flutter_accounts'
  s.version          = '0.0.1'
  s.summary          = 'Flutter plugin to communicate with kevin. accounts SDK'
  s.description      = <<-DESC
Flutter plugin to communicate with kevin. accounts SDK
                       DESC
  s.homepage         = 'https://github.com/getkevin/kevin-flutter/tree/master/packages/kevin_flutter_accounts'
  ...
  s.dependency 'kevin_flutter_core'
  s.platform = :ios, '9.0'
