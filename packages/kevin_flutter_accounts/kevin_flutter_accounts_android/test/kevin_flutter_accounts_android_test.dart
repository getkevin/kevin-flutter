...
import 'package:kevin_flutter_accounts_android/kevin_flutter_accounts_android.dart';
...
void main() {
  ...
  const channel = MethodChannel('kevin_flutter_accounts_android');
  ...
  test('registers instance', () {
    KevinFlutterAccountsAndroid.registerWith();
    expect(
      KevinFlutterAccountsPlatformInterface.instance,
      isA<KevinFlutterAccountsAndroid>(),
    );
  });
